...
{
    php_rindow_opoverride_operatable_t* obj = php_rindow_opoverride_operatable_fetch_object(object);
...
{
    php_rindow_opoverride_operatable_t* intern = NULL;

    intern = (php_rindow_opoverride_operatable_t*)ecalloc(1, sizeof(php_rindow_opoverride_operatable_t) + zend_object_properties_size(class_type));
...
/* {{{ Rindow\OpOverride\Operatable function entries */
...
void php_rindow_opoverride_operatable_init_ce(INIT_FUNC_ARGS)
{
    zend_class_entry ce;
...
#undef PROC
    ...
    INIT_NS_CLASS_ENTRY(ce, "Rindow\\OpOverride", "Operatable", object_method_entries);
